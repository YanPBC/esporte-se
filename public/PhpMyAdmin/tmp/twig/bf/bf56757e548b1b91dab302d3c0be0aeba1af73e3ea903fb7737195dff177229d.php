...
class __TwigTemplate_e2f7e8a6289929b76badc3a8b9c6c0c1c38ad90742a31fb42299f8e60aeae04d extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Remove last parameter");
        ...
        // line 74
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 74), "PROCEDURE"))) ? (" hide") : (""));
        echo "\">
          <td>";
echo _gettext("Return type");
        ...
        <tr class=\"routine_return_row";
        // line 82
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 82), "PROCEDURE"))) ? (" hide") : (""));
        echo "\">
          <td>";
echo _gettext("Return length/values");
        ...
        <tr class=\"routine_return_row";
        // line 89
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 89), "PROCEDURE"))) ? (" hide") : (""));
        echo "\">
          <td>";
...
echo _gettext("Charset");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_returnopts_text", [], "any", false, false, false, 97), twig_get_attribute($this->env, $this->source, $context["charset"], "getName", [], "method", false, false, false, 97)))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["charset"], "getName", [], "method", false, false, false, 97), "html", null, true);
            echo "</option>
                ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["numeric_option"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_returnopts_num", [], "any", false, false, false, 105), $context["numeric_option"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["numeric_option"], "html", null, true);
            echo "</option>
                ";
...
echo _gettext("SQL data access");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_sqldataaccess", [], "any", false, false, false, 161), $context["value"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["value"], "html", null, true);
            echo "</option>
              ";
...
";
    ...
    {
        return new Source("", "database/routines/editor_form.twig", "D:\\Downloads\\phpMyAdmin-5.2.1-all-languages\\phpMyAdmin-5.2.1-all-languages\\templates\\database\\routines\\editor_form.twig");
    }
}
